...
urlpatterns = [
    ...
    path('editar/jogador/<int:id>', views.player_edit, name = "player_edit"),
    path('gerenciar/time/', views.team_manage, name = "team_manage"),
    path('cadastrar/time', views.team_register, name = "team_register"),
    path('editar/time/<int:id>', views.team_edit, name = "team_edit"),
    path('gerenciar/jogadores/time/<int:id>', views.team_players_manage, name = "team_players_manage"),
    ...
    path('adicionar/jogador/time/<int:id>', views.add_player_team, name = "add_player_team"),
